...
<script type="text/javascript">
	function move_delete(){
		var url = '<%=request.getContextPath() %>/admin_review_delete.do';    // Controller로 보내고자 하는 URL (.dh부분은 자신이 설정한 값으로 변경해야됨)
...
<body class="d-flex flex-column h-100">
    ...
    <div id="admin_wrap" class="container webfont">
        ...
        <div id="section">
            <!-- 본문 타이틀 -->
            <h3 class="admin_title">리뷰 관리 <span class="sub_title2">review</span></h3>
