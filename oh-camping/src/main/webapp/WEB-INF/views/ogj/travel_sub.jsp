...
<section class="facil_detail" data-aos="fade-right">
	...
	<div class="wrap_facil_img">
		<div class="img_facil facil_1" style="background: url('${img}.jpg')no-repeat 50% 50%;background-size: cover"></div>
	</div>
	<div class="facil_detail_txt">
		<div>
			<h1 class="tit_intro bor_bottom">${text1 }</h1>
			<p class="style_intro1">
			
			${text3 }
			
			</p>
			<a href="<%=request.getContextPath()%>/travel.do" class="btn_facil_1">preview facility</a>
		</div>
	</div>
</section>
