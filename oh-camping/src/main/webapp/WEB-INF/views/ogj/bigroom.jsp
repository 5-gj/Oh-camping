...
<link rel="stylesheet" href="resources/ogjcss/bigroom.css">
<link rel="stylesheet"
	...
	AOS.init();
		...
		<div class="section1-div2-div2">
			<div class="detail_main">
				<h3>객실정보 안내</h3>
				<ul>
					<li>평수 : 약52m<sub>2</sub>(16평)</li>
					<li>객실형태 : 침대2, 화장실, 싱크대, 수영장 뷰</li>
					<li>입실시간 : 15:00</li>
					<li>퇴실시간 : 11:00</li>
				</ul>
			</div>
			...
			<div class="detail_sub">
				<h3>구비시설</h3>
				<ul>
					<li>퀸침대 2개, 추가매트리스, 호텔식 침구, 변형 침대매트리스 2개 , 냉난방기, 선풍기, TV, 와이파이, 드라이기, 전기장판 2개, 전자렌지, 전기밥솥, 커피포트, 건조대, 2구버너, 220리터 대형온수기, 개별화장실(샴푸, 린스, 바디워시), 개별싱크대(대형냄비, 소형냄비, 후라이팬, 칼, 도마, 집게 등 기본식기세트), 전용화로대, 숯 웨버그릴, 실내외 테이블 2세트(4인기준), 개별파라솔</li>
				</ul>
			</div>
			<div class="detail_sub">
				<h3>기간 안내</h3>
